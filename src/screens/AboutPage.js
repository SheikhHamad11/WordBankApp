  ...
  return (
    ...
    <View style={styles.flexContainer}>
      ...
      <Text style={styles.heading2}>
        ...
        words in any piece of academic writing adds flow, strength, readability,
        professionalism and makes the work easy to comprehend and follow.
      </Text>
      ...
      <Text style={styles.heading2}>
        ...
        of these, in turn, when tapped provide a list of examples of their use.
      </Text>

      <Text style={styles.heading2}>
        The key element in its design lies in its simplicity, convenience and
        ease of use. There are no requirements to register or log in and neither
        does it require any other details of the user.
      </Text>
      <Text style={styles.heading2}>
      ...
      <Text style={styles.heading2}>
        It is free to use with no intrusive ads and given that it is not subject
        or region-specific, it will find wide global appeal.
      </Text>
      ...
      <Text style={styles.heading2}>
        ...
        Mitchell and Mike Riddle. The various functions and associated processes
        that emanate from this model are based on the work by Nottingham Trent
        University and Learnhigher.ac.uk. The examples of the use of various
        words and phrases have been contributed by the writing mentors based at
        Liverpool Hope University Library and a number of academics from the
        University of Manchester and Liverpool Hope University. The logo was
        designed by Steve Millard of Brand Harmonics Ltd.
      </Text>

      <TouchableOpacity    onPress={() => Linking.openURL('http://www.brandharmonics.co.uk')}>
